 ...
 * 
 */
public class RichRelevanceProductBean {
  ...
  public class YmalProduct {
    ...
    /**
     * @return the cmosItemId
     */
    public String getCmosItemId() {
      return cmosItemId;
    }
    
    /**
     * @param cmosItemId
     *          the cmosItemId to set
     */
    public void setCmosItemId(final String cmosItemId) {
      this.cmosItemId = cmosItemId;
    }
